 ...
 * ======================================================================== */
define('module/slider', function(require, exports, module){
  ...
  var getIndicators = function() {
    var indicators = document.querySelectorAll('.slider > .slider-indicators > li');
    return indicators;
  }

  var setSliderIndicators = function(number) {
  ...
  var onTouchEnd = function (e) {
    ...
    for (i = indicators.length; i--;) {
      (i === Math.abs(slideNumber)) ? indicators[i].classList.add('active') : indicators[i].classList.remove('active');
    }
